...
export default function index() {
    ...
    const [isShowFilterBottom, setIsShowFilterBottom] = useState(false);

    const handleFilterButton = () => {
        setIsShowFilterBottom(!isShowFilterBottom);
    };
    ...
    return (
        <>
            ...
            <section className="faq-body">
                ...
                <FilterButton handleFilterButton={handleFilterButton} isShowFilterBottom={isShowFilterBottom} />
            </section>
        </>
    )
}
